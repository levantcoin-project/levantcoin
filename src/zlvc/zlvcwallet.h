...
#ifndef Levantcoin_ZLVCWALLET_H
#define Levantcoin_ZLVCWALLET_H
...
public:
    CzLVCWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZLVC(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZLVC(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
