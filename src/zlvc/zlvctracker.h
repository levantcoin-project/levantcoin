...
#ifndef Levantcoin_ZLVCTRACKER_H
#define Levantcoin_ZLVCTRACKER_H
...
public:
    CzLVCTracker(std::string strWalletFile);
    ~CzLVCTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzLVCWallet* zLVCWallet = NULL);
...
#endif //Levantcoin_ZLVCTRACKER_H
