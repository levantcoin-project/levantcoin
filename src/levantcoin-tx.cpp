...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Levantcoin Core levantcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  levantcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded levantcoin transaction") + "\n" +
                               "  levantcoin-tx [options] -create [commands]   " + _("Create hex-encoded levantcoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded levantcoin transaction
