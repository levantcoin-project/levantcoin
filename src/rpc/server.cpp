...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop Levantcoin server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "Levantcoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Levantcoin features */
        {"levantcoin", "listmasternodes", &listmasternodes, true, true, false},
        {"levantcoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"levantcoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"levantcoin", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"levantcoin", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"levantcoin", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"levantcoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"levantcoin", "masternodedebug", &masternodedebug, true, true, false},
        {"levantcoin", "startmasternode", &startmasternode, true, true, false},
        {"levantcoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"levantcoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"levantcoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"levantcoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"levantcoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"levantcoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"levantcoin", "preparebudget", &preparebudget, true, true, false},
        {"levantcoin", "submitbudget", &submitbudget, true, true, false},
        {"levantcoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"levantcoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"levantcoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"levantcoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"levantcoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"levantcoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"levantcoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"levantcoin", "checkbudgets", &checkbudgets, true, true, false},
        {"levantcoin", "mnsync", &mnsync, true, true, false},
        {"levantcoin", "spork", &spork, true, true, false},
        {"levantcoin", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getzlvcseed", &getzlvcseed, false, false, true},
        {"zerocoin", "setzlvcseed", &setzlvcseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzlvc", &searchdzlvc, false, false, true},
        {"zerocoin", "dzlvcstate", &dzlvcstate, false, false, true},
...
{
    return "> levantcoin-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:29003/\n";
}
