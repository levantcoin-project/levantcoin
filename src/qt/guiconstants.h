...
/* Levantcoin GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Levantcoin"
#define QAPP_ORG_DOMAIN "levantcoin.org"
#define QAPP_APP_NAME_DEFAULT "Levantcoin-Qt"
#define QAPP_APP_NAME_TESTNET "Levantcoin-Qt-testnet"
