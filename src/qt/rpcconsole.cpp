                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzLVCPathCustom = GetArg("-zlvcbackuppath", "");
    ...
    if(!strzLVCPathCustom.empty()) {
        ui->wallet_customzlvcbackuppath->setText(QString::fromStdString(strzLVCPathCustom));
        ui->wallet_customzlvcbackuppath_label->setVisible(true);
        ui->wallet_customzlvcbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzLVCPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the Levantcoin RPC console.") + "<br>" +
