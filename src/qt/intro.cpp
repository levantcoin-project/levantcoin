...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Levantcoin Core"),
     ...
     * override -datadir in the levantcoin.conf file in the default data directory
     * (to be consistent with levantcoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
