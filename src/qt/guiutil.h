...
/** Utility functions used by the Levantcoin Qt UI.
 */
namespace GUIUtil
{
...
// Render Levantcoin addresses in monospace font
...
// Parse "levantcoin:" URI into recipient object, return true on successful parsing
