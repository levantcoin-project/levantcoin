...
from fake_stake.base_test import Levantcoin_FakeStakeTest

class zLVCwrappedSerialsTest(Levantcoin_FakeStakeTest):
    ...
    def run_test(self):
        ...
        # 2) Mint zerocoins
        self.log.info("Minting %d-denom zLVCs..." % DENOM_TO_USE)
