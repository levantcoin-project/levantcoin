...
YEAR = "20[0-9][0-9]"
YEAR_RANGE = '(%s)(-%s)?' % (YEAR, YEAR)
HOLDER = 'The Levantcoin developers'
...
Arguments:
    <base_directory> - The base directory of a levantcoin source code repository.
"""
