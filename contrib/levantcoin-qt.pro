...
HEADERS += src/activemasternode.h \
           ...
           src/walletdb.h \
           src/compat/sanity.h \
           src/config/levantcoin-config.h \
           src/crypto/common.h \
...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/levantcoin-cli.cpp \
           src/levantcoin-tx.cpp \
           src/levantcoin.cpp \
           src/db.cpp \
...
RESOURCES += src/qt/levantcoin.qrc src/qt/levantcoin_locale.qrc

TRANSLATIONS += src/qt/locale/levantcoin_bg.ts \
                src/qt/locale/levantcoin_de.ts \
                src/qt/locale/levantcoin_en.ts \
                src/qt/locale/levantcoin_es.ts \
                src/qt/locale/levantcoin_fi.ts \
                src/qt/locale/levantcoin_fr.ts \
                src/qt/locale/levantcoin_it.ts \
                src/qt/locale/levantcoin_ja.ts \
                src/qt/locale/levantcoin_pl.ts \
                src/qt/locale/levantcoin_pt.ts \
                src/qt/locale/levantcoin_ru.ts \
                src/qt/locale/levantcoin_sk.ts \
                src/qt/locale/levantcoin_sv.ts \
                src/qt/locale/levantcoin_vi.ts \
                src/qt/locale/levantcoin_zh_CN.ts \
                src/qt/locale/levantcoin_zh_TW.ts
