Contributing to Levantcoin Core
============================

The Levantcoin Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/levantcoin-project/levantcoin/blob/master/doc/translation_process.md)
...
The following applies to code changes to the Levantcoin Core project, and is not to be
confused with overall Levantcoin Network Protocol consensus changes.

Whether a pull request is merged into Levantcoin Core rests with the project merge
...
Patches that change Levantcoin consensus rules are considerably more involved than
...
Where a patchset proposes to change the Levantcoin consensus, it must have been
...
The project leader is the release manager for each Levantcoin Core release.
